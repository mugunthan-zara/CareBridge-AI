...
function screen(id) {
    ...
    console.log("CAREBRIDGE NAVIGATION:", id);
    ...
    console.log("ACTIVE SCREEN:", target.id);
...
// ============================================================
// GLOBAL NAVIGATION
// Each data-action button opens ONLY its own screen.
// AI Assistant opens ONLY from data-action="assistant".
// ============================================================
...
} // ← CLOSE openPersonalizedDashboard()
